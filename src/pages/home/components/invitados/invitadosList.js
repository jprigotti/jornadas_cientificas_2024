export const invitadosList = [
  ...
  },
  {
    ...
    name: "Prof. Eduardo Sacheri",
    cv1: "Profesor y Licenciado en Historia | Guionista y colabora en diarios y revistas nacionales e internacionales",
    cv2: `Autor de cuentos y novelas, toda su obra se encuentra en Alfaguara: 
          los libros de relatos Esperándolo a Tito, Te conozco, 
          Mendizábal, Lo raro empezó después, Un viejo que se pone de pie,
          La noche de la Usina (Premio Alfaguara de Novela 2016), Lo mucho
          que te amé, El funcionamiento general del mundo y Nosotros dos en
          la tormenta.
          Aráoz y la verdad fue adaptada al teatro y La pregunta de sus
          ojos, Papeles en el viento y La noche de la Usina fueron llevadas
